...
class Report_dosen extends CI_Controller {
	...
	{
		$arr['breadcrumbs'] = 'report';
		$arr['content'] = 'login_dosen/vw_report_mata_kuliah';
 ...
 public function download_report_mata_kuliah()
	...
	{
		$arr['breadcrumbs'] = 'report';
		$arr['content'] = 'login_dosen/vw_report_relevansi_ppm';
	...
	{
		$arr['breadcrumbs'] = 'report';
		$arr['content'] = 'login_dosen/vw_report_efektivitas_cpl';
	...
	{ 
		$arr['breadcrumbs'] = 'report';
		$arr['content'] = 'login_dosen/vw_report_epbm';
	...
	{ 
		$arr['breadcrumbs'] = 'report';
		$arr['content'] = 'login_dosen/vw_report_epbm_2';
