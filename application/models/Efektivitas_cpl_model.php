<?php
class efektivitas_cpl_model extends CI_Model 
{
	...
	public function update_excel_nilai_efektivitas_cpl($save_data)  
	{
		$result = $this->db->replace('nilai_efektivitas_cpl',$save_data);
		return true;
	}
