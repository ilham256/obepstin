<?php
class cpmklang_model extends CI_Model 
{
	...
	public function get_cpmklang($data_mata_kuliah)  
	{
		$query = $this->db->select('*');
		$query->from('nilai_cpmk');
		$query->join('matakuliah_has_cpmk','matakuliah_has_cpmk.id_matakuliah_has_cpmk = nilai_cpmk.id_matakuliah_has_cpmk');
	...
	{
		$result = $this->db->replace('nilai_cpmk',$save_data);
		return true;
	}
