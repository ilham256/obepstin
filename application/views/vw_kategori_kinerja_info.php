					...
					<div class="col-sm-12 col-md-6">
						<div class="box-content card">
							...
							<div class="card-content">
								...
								<div class="float-end">
									<a onclick="return confirm('apakah anda ingin mengubah data ?')" class="btn btn-warning waves-effect waves-light" href="<?php echo site_url('katkin/edit_katkin'); ?>">Edit</a>
								</div>
							</div>
							<!-- /.card-content -->
						</div>
