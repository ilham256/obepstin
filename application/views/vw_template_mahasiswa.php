				...
				<li <?php echo ($breadcrumbs == 'report' || $breadcrumbs == 'relevansi_ppm' || $breadcrumbs == 'efektivitas_cpl' || $breadcrumbs == 'report_epbm' ? ' class = "current active"' : '') ?>>
					...
					<ul class="sub-menu js__content">
						<li <?php echo ($breadcrumbs == 'report' ? ' class = "current"' : '') ?>>
							<a href="<?php echo site_url('report_mahasiswa') ?>">Report Mahasiswa</a>
						</li>
					</ul>
				</li>
				<li <?php echo ($breadcrumbs == 'akun' ? ' class = "current active"' : '') ?>>
					<a class="waves-effect" href="<?php echo site_url('akun_mahasiswa') ?>"><i class="menu-icon ti-user"></i>Akun</a>
				</li>
