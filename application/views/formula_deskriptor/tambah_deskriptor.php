<div class="row small-spacing">
	<div class="col-lg-12 col-xs-12">
		<div class="box-content">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="<?php echo site_url('formula_deskriptor/submit_tambah_deskriptor') ?>" enctype="multipart/form-data">
	                <div class="card-body">

	                		<div class="form-group">
			                    <label for="exampleInputEmail1">Kode CPL</label>
			                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?= $data->id_cpl_langsung ?>" disabled >
			                    <input type="hidden" name="id_cpl" value="<?= $data->id_cpl_langsung ?>">
			                </div>
			                  <br>
			                <div class="form-group">
